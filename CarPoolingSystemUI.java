...
public class CarPoolingSystemUI {
    ...
    private int driverCounter = 1; // For assigning unique driver IDs
    ...
    private void showBookingScreen() {
        ...
        bookBtn.addActionListener(e -> {
            ...
            // Optional: remove driver after assigning (comment this if you want driver to stay available)
    ...
    private void showDriverScreen() {
        ...
        registerBtn.addActionListener(e -> {
            ...
            String driverId = "D" + driverCounter++;
